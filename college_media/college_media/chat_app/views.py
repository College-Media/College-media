...
def chat_view(request, conversation_id):
    ...
    # making chats as read
    message_read=Notification.objects.filter(receiver=sender_id,sender=receiver)
    print("data in notification tabel")
    print("____________________________________________________")
    for i in message_read:
        print('{}is sender and {} is receiver'.format(i.sender,i.receiver))
        i.is_read=True
        i.save()
